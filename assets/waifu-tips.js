...
re.toString = function() {
    showMessage('读书很重要哦~', 5000, true);
    return '';
};

$(document).on('copy', function (){
    showMessage('你都学习了些什么呀，要记笔记哦~', 5000, true);
});
...
$('.waifu-tool .fui-cross').click(function (){
    ...
    showMessage('愿你在知识的海洋里畅游!', 1300, true);
    window.setTimeout(function() {$('.waifu').hide();}, 1300);
});

$('.waifu-tool .fui-photo').click(function (){
    showMessage('书选好了么，是不是很兴趣呢？', 5000, true);
...
function waifuWelcome(){
    ...
    if (window.location.href == SiteIndexUrl) {      // 如果是主页
        ...
        if (now > 23 || now <= 5) {
            ...
            text = '中午了，可以休息一会儿，再继续哦！';
        } else if (now > 14 && now <= 17) {
            text = '下午了，今天的读书目标完成了吗？';
...
var waifuJson = {
    "mouseover": [
        ...
        {
            "selector": ".aboutme",
            "text": ["发现管理员出没地点！", "这里有管理员的联系方式"]
        },
        {
            "selector": ".donate-qrcode",
            "text": ["管理员最近有些辛苦哦，耐心等待一下哦~"]
        },
        {
        ...
        },
        {
            ...
            "text": ["干嘛呢你，快去读书哦", "加油加油加油~~"]
        }
    ],
    "click": [
        {
            "selector": ".waifu #live2d",
            "text": ["读书破万卷,下笔如有神。——杜甫", "读万卷书，行万里路。　——顾炎武", "读书之法，在循序渐进，熟读而精思。　——朱煮", "书犹药也，善读之可以医愚。　——刘向", "学而不厌，诲人不倦。　——孔丘"]
        }
    ],
    "seasons": [
        {
            "date": "01/01",
            "text": "<span style=\"color:#0099cc;\">元旦</span>了呢，新的一年要读更多的书哦，今年是{year}年~"
        },
        {
            "date": "02/14",
            "text": "又是一年<span style=\"color:#0099cc;\">情人节</span>，{year}年找到一起看书的小伙伴了嘛~"
        },
        {
            "date": "03/08",
            "text": "今天是<span style=\"color:#0099cc;\">妇女节</span>！来了解了解关于妇女的书吧"
        },
        {
            "date": "03/12",
            "text": "今天是<span style=\"color:#0099cc;\">植树节</span>，看看保护环境手册呀！"
        },
        {
            "date": "04/01",
            "text": "悄悄告诉你一个秘密~<span style=\"background-color:#34495e;\">今天是愚人节，来本有趣的书如何~</span>"
        },
        {
            "date": "05/01",
            "text": "今天是<span style=\"color:#0099cc;\">五一劳动节</span>，假期有书籍来休闲时光~"
        },
        {
            "date": "06/01",
            "text": "<span style=\"color:#0099cc;\">儿童节</span>了呢，回忆回忆童话故事…"
        },
        {
            "date": "09/03",
        ...
        {
            "date": "10/01",
            "text": "<span style=\"color:#0099cc;\">国庆节</span>，了解了解中国的发展历史吧！"
        },
        {
            "date": "11/05-11/12",
            "text": "今年的<span style=\"color:#0099cc;\">双十一</span>有想买的书吗~"
        },
        {
            "date": "12/20-12/31",
            "text": "这几天是<span style=\"color:#0099cc;\">圣诞节</span>，西方书籍有哪些呢？"
        }
    ]
};
